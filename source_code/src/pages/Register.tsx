...
import { User, Mail, Lock, Phone, UserPlus, Eye, EyeOff, ShieldCheck, Sparkles, CheckCircle2 } from 'lucide-react';
...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success('Account created! Welcome to DebtRelief AI.');
  ...
  return (
    <div className="min-h-screen mesh-bg grid lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center p-6 lg:p-12 order-2 lg:order-1">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="glass-card p-8">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Start your financial recovery journey today</p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input value={form.fullName} onChange={set('fullName')} placeholder="John Doe" className="input-field pl-10" required />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" value={form.email} onChange={set('email')} placeholder="you@example.com" className="input-field pl-10" required />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input value={form.phone} onChange={set('phone')} placeholder="+1 555 000 0000" className="input-field pl-10" required />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type={showPwd ? 'text' : 'password'} value={form.password} onChange={set('password')} placeholder="••••••" className="input-field pl-10 pr-9" required />
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock size={17} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" />
                    <input type={showPwd ? 'text' : 'password'} value={form.confirm} onChange={set('confirm')} placeholder="••••••" className="input-field pl-10" required />
                  </div>
                </div>
              </div>
      ...
      {/* Right — brand panel */}
      <div className="hidden lg:flex relative overflow-hidden order-1 lg:order-2">
        ...
        <div className="relative flex flex-col justify-between p-12 text-white w-full">
          <div className="flex justify-end"><Link to="/"><Logo showText={false} size="lg" /></Link></div>
          <div>
            <h2 className="text-4xl font-bold font-display leading-tight text-balance">
              Your AI partner for debt relief
            </h2>
            <p className="mt-4 text-white/80 text-lg max-w-md">
              Create a free account to unlock intelligent settlement recommendations, AI-generated letters, and a full financial health dashboard.
            </p>
            <div className="mt-8 space-y-3">
              {[
                { icon: CheckCircle2, text: 'Free to get started — no credit card' },
                { icon: Sparkles, text: 'Google Gemini-powered recommendations' },
